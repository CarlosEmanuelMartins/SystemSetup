...
1. Download the Spotify setup of old version (1.0.80.474) from the link given below. Make sure to download the same version that is 1.0.80.474.
   https://filehippo.com/download_spotify/1.0.80.474.0/
2. Uninstall any version of Spotify (if installed).
3. Install Spotify by using the Setup of old version that you downloaded in Step 4.
5. Search for Notepad in Start menu. Right click and Open as Administrator. **(IMPORTANT: must be done this way)**
6. In Notepad click on File -> Open and go to this location 
   C:\Windows\System32\drivers\etc
7. It will show no files. In the right bottom click on Text Documents and select All Files.
8. Then click on the file named hosts and click Open.
9. Now copy paste the text from below.
10. Save the hosts file. That's it.
11. Run Spotify. Login and listen to music ad-free.
...
0.0.0.0 star-z-mini.c10r.facebook.com
0.0.0.0 secure-gg.imrworldwide.com
0.0.0.0 imagesrv.adition.com
0.0.0.0 ad3.adfarm1.adition.com
0.0.0.0 a301.w62d.akamai.net
0.0.0.0 a297.c.akamai.net
0.0.0.0 beta.spotify.map.fastly.net
0.0.0.0 prod.spotify.map.fastlylb.net
0.0.0.0 adclick.g.doublecklick.
0.0.0.0 adeventtracker.spotify.
0.0.0.0 ads-fa.spotify.0.0.0.0 ads.pubmatic.c
0.0.0.0 analytics.spotify.
0.0.0.0 b.scorecardresearch.
0.0.0.0 bounceexchange.
0.0.0.0 bs.serving-sys.
0.0.0.0 content.bitsontherun.
0.0.0.0 core.insightexpressai.
0.0.0.0 d2gi7ultltnc2u.cloudfront.
0.0.0.0 d3rt1990lpmkn.cloudfront.
0.0.0.0 doubleclick.
0.0.0.0 ds.serving-sys.0.0.0.0 gads.pubmatic.c
0.0.0.0 googleads.g.doubleclick.
0.0.0.0 gtssl2-ocsp.geotrust.
0.0.0.0 js.moatads.
0.0.0.0 log.spotify.
0.0.0.0 media-match.
0.0.0.0 omaze.
0.0.0.0 pagead46.l.doubleclick.
0.0.0.0 pagead2.googlesyndication.
0.0.0.0 partner.googleadservices.
0.0.0.0 pubads.g.doubleclick.
0.0.0.0 redirector.gvt1.
0.0.0.0 s0.2mdn.
0.0.0.0 securepubads.g.doubleclick.n
0.0.0.0 tpc.googlesyndication.
0.0.0.0 v.jwpcdn.
0.0.0.0 video-ad-stats.googlesyndication.
0.0.0.0 weblb-wg.gslb.spotify.
0.0.0.0 www.googleadservices.
0.0.0.0 www.googletagservices.
